...
# my packages
from data_process import MovieLen

class BaselineModel(paddle.nn.Layer):
    def __init__(self,
                 user_info_file,
                 user_rating_file,
                 movies_info_file,
        ...
        Dataset = MovieLen(user_info_file, user_rating_file, movies_info_file, use_poster, poster_directory, poster_rating_file)
