...
class MovieLen(object):
    def __init__(self,
                 ...
                 movies_info_file,
                 use_poster=False,
                 poster_directory=None,
                 poster_rating_file=None):
        self.use_poster = use_poster
        # 声明每个数据文件的路径
        usr_info_path = user_info_file
        if use_poster:
            rating_path = poster_rating_file
        else:
            rating_path = user_rating_file

        movie_info_path = movies_info_file
        self.poster_path = poster_directory
        # 得到电影数据
...
if __name__ == '__main__':
    ...
    # 声明数据读取类
    dataset = MovieLen(user_info_file,
                       user_rating_file,
                       movies_info_file,
                       use_poster,
                       poster_directory,
